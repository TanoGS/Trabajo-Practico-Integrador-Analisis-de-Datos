...
* **Generación de gráficos:** Mínimo 4 gráficos utilizando **Matplotlib** y **Seaborn**.
* **Estándar profesional:** Los gráficos deben incluir títulos, leyendas, escalas correctas y un análisis escrito detallando qué "dice" cada visualización.
...
* **Requisito fundamental:** La interfaz debe permitir filtrar datos (por comisión, estado o fecha) y actualizar los gráficos en tiempo real.
